urls = {
       'login': 'https://intrawww.ing.puc.cl/siding/index.phtml',
        ...
        'new_folder': 'https://intrawww.ing.puc.cl/siding/dirdes/ingcursos/cursos/index.phtml?accion_curso=carpetas&acc_carp=insert_carpeta&id_curso_ic={0}&volver_carpetas',
        'new_subfolder': 'https://intrawww.ing.puc.cl/siding/dirdes/ingcursos/cursos/index.phtml?accion_curso=carpetas&acc_carp=insert_subcarpeta&id_curso_ic={0}&volver_carpetas',
